import BrowserStorageDB from './BrowserStorageDB';
...
describe('BrowserStorageDB', () => {
    const mockedLocalStoarge = new LocalStorageMock();
    const dbName = 'testDB';
    const db = new BrowserStorageDB(dbName, mockedLocalStoarge);
    const initialState = [
    ...
    it('should insert document to empty DB', () => {
        ...
        const emptyDB = new BrowserStorageDB('emptyDB', mockedEmptyLocalStorage);
