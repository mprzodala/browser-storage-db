...
class BrowserStorageDB {
    ...
    static filterByQuery(documents, query) {
        ...
        documents.forEach((document) => {
            if (BrowserStorageDB.isMatchQuery(document, query)) results.push(document);
        });
        return results;
    }
    ...
    find(query) {
        ...
        return BrowserStorageDB.filterByQuery(documents, query);
    }
    ...
    update(id, data) {
        ...
        const [document] = BrowserStorageDB.filterByQuery(documents, { id });
...
export default BrowserStorageDB;
